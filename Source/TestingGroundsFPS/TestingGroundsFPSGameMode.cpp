	...
	: Super()
{
	...
	static ConstructorHelpers::FClassFinder<APawn> PlayerPawnClassFinder(TEXT("C:/UE4/TestingGroundsFPS/Content/FirstPersonCPP/Blueprints/FirstPersonCharacter"));
